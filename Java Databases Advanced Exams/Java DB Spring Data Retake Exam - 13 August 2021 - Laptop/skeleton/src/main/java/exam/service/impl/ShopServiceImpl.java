...
public class ShopServiceImpl implements ShopService {
    ...
    private static final String SHOP_FILE_PATH = "skeleton/src/main/resources/files/xml/shops.xml";
    ...
    public String importShops() throws JAXBException, FileNotFoundException {
        ...
        xmlParser.fromFile(SHOP_FILE_PATH, ShopSeedRootDTO.class)
                ...
                .stream()
                .filter(shopSeedDTO -> {
                    boolean isValid = validationUtil.isValid(shopSeedDTO) && !isEntityExist(shopSeedDTO.getName());
